    ...
    <div className="max-w-6xl mx-auto space-y-16 animate-slide-up pb-12">
      <div className="text-center py-12">
        ...
        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
          Profesionales apasionados y dedicados a brindarte la mejor atención. Conócelos a continuación.
        </p>
      </div>
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-gray-500 dark:text-gray-400">Cargando a nuestros especialistas...</p>
        </div>
      ) : (
      ...
      <div className="pt-8 border-t border-gray-100 dark:border-dark-800">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Nuestros Pilares</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-50 dark:bg-dark-800/50 p-8 rounded-2xl text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Experiencia</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Años de trayectoria garantizan nuestro nivel de servicio.</p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-dark-800/50 p-8 rounded-2xl text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Precisión</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Atención al detalle en cada servicio que ofrecemos.</p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-dark-800/50 p-8 rounded-2xl text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Confianza</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Transparencia y seguridad en la gestión de turnos.</p>
          </div>
        </div>
      </div>
    </div>
